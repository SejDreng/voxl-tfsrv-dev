...
#define MPA_PAYL_FLAG_ACTUATOR_OK (1<<0)
#define MPA_PAYL_FLAG_DISCONNECT  (1<<1)
#define MPA_PAYL_FLAG_ERROR       (1<<2)
#define MPA_PAYL_FLAG_INPUT_ERROR (1<<3)
#define MPA_PAYL_FLAG_STARTUP     (1<<4)
#define MPA_PAYL_FLAG_IDLE        (1<<5)
#define MPA_PAYL_FLAG_ARMED       (1<<6)
#define MPA_PAYL_FLAG_TRIGGERED   (1<<7)
#define MPA_PAYL_FLAG_OPEN        (1<<8)
#define MPA_PAYL_FLAG_CLOSED      (1<<9)
#define MPA_PAYL_FLAG_SST_30      (1<<10)
#define MPA_PAYL_FLAG_SST_60      (1<<11)
#define MPA_PAYL_FLAG_SST_90      (1<<12)
#define MPA_PAYL_FLAG_EN_IMP      (1<<13)
#define MPA_PAYL_FLAG_EN_FAR      (1<<14)
#define MPA_PAYL_FLAG_EN_NEAR     (1<<15)
#define MPA_PAYL_FLAG_ARMED_IMP   (1<<16)
#define MPA_PAYL_FLAG_ARMED_FAR   (1<<17)
#define MPA_PAYL_FLAG_ARMED_NEAR  (1<<18)
...
typedef struct payload_status_t
{
    ...
    char actuator_status[64]; ///< Actuator Status string
...
payload_status_t *pipe_validate_payload_status_t(char *data, int bytes, int *n_packets);
