...
DEFINE_PIPE_VALIDATOR(pipe_validate_vqf_data_t, vqf_data_t, VQF_MAGIC_NUMBER)
...
DEFINE_PIPE_VALIDATOR(pipe_validate_ext_vfc_data_t, ext_vfc_data_t, EXT_VFC_MAGIC_NUMBER)
...
DEFINE_PIPE_VALIDATOR(pipe_validate_payload_status_t, payload_status_t, PAYLOAD_STATUS_MAGIC_NUMBER)
...
const char* pipe_vfc_submode_to_string(int i)
{
    switch(i){
        case VFC_SM_NONE:
            return "NONE";
        case VFC_SM_THRUST_ATTITUDE:
            return "THRUST_ATTITUDE";
        case VFC_SM_ALTITUDE_ATTITUDE:
            return "ALTITUDE_ATTITUDE";
        case VFC_SM_ALTITUDE_FLOW:
            return "ALTITUDE_FLOW";
        case VFC_SM_POSITION:
            return "POSITION";
        case VFC_SM_TRAJ:
            return "TRAJ";
        case VFC_SM_BACKTRACK:
            return "BACKTRACK";
        default:
            return "Unknown VFC Submode";
    }
}
...
const char* pipe_vfc_submode_to_string_osd(int i)
{
    switch(i){
        ...
        case VFC_SM_THRUST_ATTITUDE:
            return "MANUAL (VIO)";
        case VFC_SM_ALTITUDE_ATTITUDE:
            return "ALTITUDE HOLD (VIO)";
        case VFC_SM_ALTITUDE_FLOW:
            return "3D HOLD (OPTIC FLOW)";
        case VFC_SM_POSITION:
            return "3D HOLD (VIO)";
        case VFC_SM_TRAJ:
            return "AUTONOMOUS";
