...
// include the new model helpers here
                                 ...
                                 NormalizationType do_normalize)
{
    ...
    case XOR:
    {
        ...
        {
            return new XORModelHelper(model, labels_in_use, opt_, en_debug, en_timing, do_normalize); // this is a placeholder, need to implement the actual model helper for this
        }
        else
        {
            fprintf(stderr, "Unsupported category for the given model\n");
    ...
    case PIML:
    {
        if (model_category == REGRESSION)
        {
            return new PIMLModelHelper(model, labels_in_use, opt_, en_debug, en_timing, do_normalize);
        }
        else
        {
            fprintf(stderr, "Unsupported category for the given model\n");
